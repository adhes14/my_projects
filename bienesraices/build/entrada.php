...
?>
    ...
    <main class="contenedor seccion contenido-centrado">
        <h1>Guía para la decoración de tu hogas</h1>

        <picture>
            <source srcset="img/destacada2.webp" type="image/webp">
            <source srcset="img/destacada2.jpg" type="image/jpeg">
            <img src="img/destacada2.jpg" alt="imagen de la Propiedad" loading="lazy">
        </picture>

        <p class="informacion-meta">Escrito el: <span>28/10/2021</span> por: <span>Admin</span></p>
